...
public class EditarMaestroForm extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        this.txtRfc2.setText(modelo.getRfc());
    ...
    public boolean esValido() {
        if (txtRfc2.getText().trim().isEmpty()) {
    ...
    private void initComponents() {
        ...
        txtRfc2 = new swim.text.TextField();
        ...
        txtRfc2.setFont(new java.awt.Font("Corbel", 0, 14)); // NOI18N
                ...
                .addGroup(myPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, myPanel2Layout.createSequentialGroup()
                        .addGroup(myPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtRfc2, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(36, 36, 36)
                        .addGroup(myPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(myPanel2Layout.createSequentialGroup()
    ...
    private void EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarActionPerformed
        if (esValido()) {
            int option = JOptionPane.showConfirmDialog(null, "¿Estas seguro de actualizar al alumno : " + txtNombre.getText() + " con matricula: " + txtRfc2.getText() + " ?");

            if (option == JOptionPane.OK_OPTION) {

                modelo.setRfc(txtRfc2.getText().trim());
                ...
                modelo.setPasswordTemp(txtRfc2.getText().trim());
    ...
    private void btnCamaraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCamaraActionPerformed
        if (!txtRfc2.getText().isEmpty()) {

            CamaraDialog dialogo = new CamaraDialog(null, true, txtRfc2.getText().trim());
    ...
    private swim.text.TextField txtRfc2;
